...
const qrImage = await pdfDoc.embedPng(base64Data);
  ...
  // On a la base; il reste les explications et les identifiants
   page.drawText(`Identité : ${await getConducteur(id)}`, {x:300, y:400, size:12, font, color:rgb(0,0,0)});
    page.drawText(`Mot de passe : ${await getKind(id, "password")}`, {x:300, y:370, size:12, font, color:rgb(0,0,0)});
